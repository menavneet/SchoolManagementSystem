...
<div class="row-fluid">
    <div class="span12">
        ...
        <div class="block-fluid">
            ...
            <div class="row-form clearfix">
                <div class="span3"><strong>Name &amp; Enroll No.</strong></div>
                <div class="span4"><span id="result_details_section"><select name="student_id" id="student_id"><option value="">Choose Enrollment No</option></select></span></div>
            </div>
            <div class="row-form clearfix">
                <div class="span3"><strong>Fee Mode</strong></div>
                <div class="span4"><select name="fees_mode_id" id="fees_mode_id"><option value="">Choose Fee Mode</option> <option value="1">Monthly</option><option value="2">Quarterly</option><option value="3">Half-Yealry</option><option value="4">Yearly</option></select></div>
            </div>
            <div class="row-form clearfix" style="border-bottom: 0px none;">
                <div class="span3"><strong>Duration</strong></div>
                <div class="span4"><span id="result_details"><select name="fees_duration_id" id="fees_duration_id"><option value="">Choose Duration</option> </select></span></div>
            </div>			
